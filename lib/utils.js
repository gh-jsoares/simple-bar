...
export function startSliding(container, innerSelector, sliderSelector) {
  ...
  slider.style.animation = `slide-text ${timing}ms linear infinite alternate`;
  slider.style.setProperty("--slide-delta", `${delta}px`);
}
...
export function stopSliding(container, sliderSelector) {
  ...
  slider.style.removeProperty("--slide-delta");
}
